...
def get_correls_on_norm_columns(df, cols):
    ...
    winning_keys = ['50_beta_SPY_norm', 'median_ratio_norm', 'ma_med_34_ratio_norm', 'awesome_osc_norm',
                    'distance_from_10_ma_norm', 'rsi_norm', 'stochastic_k_norm', 'atr_volatility_norm']
